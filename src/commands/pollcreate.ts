...
export const pollcreate = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((opt) =>
      opt.setName("option6").setDescription("Option 6").setRequired(false)
    )
    .addStringOption((opt) =>
      opt.setName("option7").setDescription("Option 7").setRequired(false)
    )
    .addStringOption((opt) =>
      opt.setName("option8").setDescription("Option 8").setRequired(false)
    )
    .addStringOption((opt) =>
      opt.setName("option9").setDescription("Option 9").setRequired(false)
    )
    .addStringOption((opt) =>
      opt.setName("option10").setDescription("Option 10").setRequired(false)
    ),
